...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: 'https://mlbbtopup.in/blog/mlbb/guides/mlbb-gameplay-guide.png', width: 1200, height: 630, alt: 'The Complete Mobile Legends Gameplay Guide: 2026 Edition (India)' }],
  },
  twitter: {
