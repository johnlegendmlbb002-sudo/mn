...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "mlbb diamond top up guide india"
  ],
  ...
  return (
    ...
    >
      <div className="space-y-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 my-10 border-y border-[var(--border)] py-8">
        ...
        <div className="mt-20 pt-10 border-t border-[var(--border)] space-y-8">
          <h4 className="text-xl font-black italic uppercase tracking-widest opacity-40">Safe Top-Up FAQ</h4>
