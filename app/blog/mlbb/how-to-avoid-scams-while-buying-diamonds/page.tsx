      ...
      <div className="space-y-10">
        ...
        <section>
          ...
          <p className="mt-12 text-lg leading-relaxed text-justify">
            <strong>Ready for a Safe Recharge?</strong> Stop worrying about your account's safety. We provide the <strong>safest and fastest MLBB diamonds in India</strong>. No passwords, no risk—just instant delivery. Visit the <Link href="/games/mobile-legends270" className="text-[var(--accent)] underline font-black italic">MLBB Diamond Store</Link> on <a href="https://bluebuff.in" className="text-[var(--accent)] font-bold">bluebuff.in</a> and buy with total confidence!
          </p>
        </section>
